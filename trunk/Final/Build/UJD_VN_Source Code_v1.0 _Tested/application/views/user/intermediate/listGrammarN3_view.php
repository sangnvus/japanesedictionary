...
<head>
	...
	<title>Danh sách ngữ pháp N3</title>
</head>
<body>
<div id="container">
		<?php 
				...
				<div id="main-content">
					<div id="left-content">
						...
						<table width="100%" cellpadding="8">
			             ...
			             <?php 
			             	foreach ($listGrammarN3 as $row) {
			              ?>
			             <tr><td bgcolor="E5EFF8">
			             <?php echo '<a href="'.base_url().'index.php/Home/home/detailGrammarN3/'.$row['reading_id'].'">';?>
			             <?php echo $row['reading_title']; ?>_文法</a></td></tr>
			             <?php } ?>		
			             </tbody>            
            			</table>
            			</div>
