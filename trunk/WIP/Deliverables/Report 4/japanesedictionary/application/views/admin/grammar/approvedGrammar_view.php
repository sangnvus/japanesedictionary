...
<head>
	<meta charset="UTF-8">
	<title>Approved Grammar Page</title>
	...
	<div id="giua">
		...
		<center>
			...
			<form name="addGrammar" id="addNewAdmin" action="" method="post" enctype="multipart-formdata">		        		        		        
		        ...
		        <label>Level: </label>
		        		<select name="g_level" style="margin-right:183px">
                    ...
                    </select><font width="1%" style="color:red;">(*)</font><br />
		        <br />
		        <label>Meaning: </label><?php echo form_input($g_meaning);?><font width="1%" style="color:red;">(*)</font><br /><br />
		        <label>Usage: </label><?php echo form_textarea($g_use);?><font width="1%" style="color:red;">(*)</font><br /><br />
		        <label>Lesson: </label><?php echo form_input($g_lesson);?><br /><br />
		        <label>&nbsp;</label> <input type="submit" name="ok" value="Approved" style="margin-right:174px" /><br />
		    </form>
			</center>
		</div>
		</div>
