...
<head>
	...
	<title>Danh sách chữ Hán N4</title>
</head>
<body>
<div id="container">
		<?php 
	...
	<div id="content">
		...
		<div id="noidung">
				...
				<div id="main-content">
					<div id="left-content">
						<div id="intro-content">
							<center><h2 style="color:blue;">DANH SÁCH CHỮ HÁN N4</h2></center>
	        <?php if ($kanji !== null) {?>
			...
			<div align="right" id="paging" class="pagination" style="margin-right:5%">
	                  <?php
	                    if($num_rows_kanjiN4>0){
	                        echo $links;
	                        echo " | Số từ : ".$num_rows_kanjiN4;
	                    }
	                  ?>
	            </div>
			<?php }else
