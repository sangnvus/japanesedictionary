...
<head>
	...
	<title>Danh sách chữ Hán N1</title>
</head>
<body>
<div id="container">
		<?php 
				...
				<div id="main-content">
					<div id="left-content">
						<div id="intro-content">
							<center><h2 style="color:blue;">DANH SÁCH CHỮ HÁN N1</h2></center>
	        <?php if ($kanji !== null) {?>
			<table id="table1" cellpadding="10" cellspacing="1">
				<tbody><tr>
				<th>CHỮ HÁN</th>
				<th>ÂM HÁN</th>
				<th>ÂM ÔN</th>
				<th style="width:30%">ÂM KUN</th>
				<th>NGHĨA</th>
				</tr>
