...
<head>
	...
	<title>Chi tiết ngữ pháp N3</title>
</head>
<body>
<div id="container">
		<?php 
			...
			<center>
				...
				<div id="main-content">
					<div id="left-content">
						...
						<div id="left"><a style="font-size:20px;" id="btnSearch" href="<?php echo base_url();?>index.php/Home/home/GrammarN3">Quay lại &nbsp</a></div><br>
