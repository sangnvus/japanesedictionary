	...
	<div id="content">
		...
		<div id="noidung">
				...
				<div id="main-content">
					<div id="left-content">
						<div id="intro-content">
							<center><h2 style="color:blue;">DANH SÁCH BÀI NGHE N2&N3</h2></center>
			...
			<table id="table1" cellpadding="10">
				...
				<?php if($num_rows_listeningN2N3 > 0){ ?>	
			...
			<div align="right" id="paging" class="pagination" style="margin-right:5%">
	                  <?php
	                    if($num_rows_listeningN2N3>0){
	                        echo $links;
	                        echo " | Số bài : ".$num_rows_listeningN2N3;
	                    }
	                  ?>
	            </div>
			<?php }else
