		...
		<center>
			...
			<table  border="0" cellpadding="10" id="table1">
                ...
                <tr align="left">
                    ...
                    <td width="60%"><img src="<?php echo base_url();?>public/image/<?php echo $info['c_image'];?>" width="150" height="100">
                    <?php if(isset($errorImage) && !is_null($errorImage)){
                        echo $errorImage;
                    }                    
                    ?>
                    <input type="file" name="userfile" id="file"><br><?php echo form_input($c_image);?></td>
                    <?php }else{ ?>
                    <td>No image<br><input type="file" name="userfile" id="file"></td>
                    <?php } ?>
                </tr>
                <tr>
                    <td></td>
