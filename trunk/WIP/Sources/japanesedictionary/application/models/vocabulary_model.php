...
class Vocabulary_model extends CI_Model
{
    ...
    function lookupSpecialized($keyword){  
        $table = '(SELECT v.v_id,v.v_hiragana,v.v_romaji,v.v_status,m.m_id,m.m_meaningvn,m.m_category,m.m_kanji,m.m_specialized
         FROM vocabulary as v LEFT JOIN meaning as m ON v.v_id=m.v_id WHERE m.m_specialized !="" AND v.v_status=1) AS A';
