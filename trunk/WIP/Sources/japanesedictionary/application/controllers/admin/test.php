...
{	
    ...
    function addQuestion() {
        ...
        if(isset($_POST['ok'])){            
            ...
            $correctAnswer = array('c1' => $this->input->post("correctAnswer1"),
                                    'c2' => $this->input->post("correctAnswer2"),
                                    'c3' => $this->input->post("correctAnswer3"),
                                    'c4' => $this->input->post("correctAnswer4")
                                    );
            $dem = 0;
            ...
            if($this->form_validation->run()==FALSE){   
                ...
                if ($dem == 0) {
                    ...
                    if ($dem == 1) {
                        ...
                        $data['error'] = "Only have one correct answer!";
                        $this->load->view("admin/test/addQuestion_view",$data);
                    }                    
                }                               
            }
