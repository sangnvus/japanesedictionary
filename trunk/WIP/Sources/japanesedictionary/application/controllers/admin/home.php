...
class Home extends CI_Controller
{
	...
	public function addNewAdmin(){		
        $this->form_validation->set_rules("username","username","required|min_length[6]|alpha_numeric|max_length[32]|callback_checkUser");
    ...
    function editAdmin(){
        ...
        {            
            ...
            {                            
                    ...
                    $this->form_validation->set_rules("newpassword","NewPassword","min_length[6]|max_length[32]|matches[renewpassword]"); 
                    $this->form_validation->set_rules("renewpassword","Re-NewPassword","matches[newpassword]");
