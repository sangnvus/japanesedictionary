    ...
    function editTraininglistening(){
        ...
        {            
            ...
            {                       
                    ...
                    $this->form_validation->set_rules("lis_id","lis_id","required");
                    $this->form_validation->set_rules("lis_level","lis_level","required|max_length[10]");
                    $this->form_validation->set_rules("lis_title","lis_title","required|max_length[500]");
                    $this->form_validation->set_rules("sourcefile_id","sourcefile_id","required|max_length[100]");                    
                    $this->form_validation->set_rules("sourcefile_question","sourcefile_question","required|max_length[5000]");                
                    $this->form_validation->set_rules("sourcefile_script","sourcefile_script","required|max_length[5000]");                                          
                    $this->form_validation->set_rules("sourcefile_meaning","sourcefile_meaning","required|max_length[5000]");
                    $this->form_validation->set_rules("sourcefile_answer","sourcefile_answer","required|max_length[100]");
