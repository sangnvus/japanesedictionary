...
class Video extends CI_Controller
{
	...
	function addVideo(){
        ...
        if (isset($_POST['addnew'])) {
            ...
            $this->form_validation->set_rules("vi_title","vi_title","required|max_length[200]");
            $this->form_validation->set_rules("vi_link","vi_link","required|max_length[200]|is_unique[video.vi_link]");                            
	...
	function editVideo(){
        ...
        {            
            ...
            {                                               
                    ...
                    $this->form_validation->set_rules("vi_link","URL","required|max_length[200]|callback_checkURL");                                                                
    ...
    function checkURL($vi_link)
    {
        ...
        if($this->Video_model->checkURL($vi_link,$vi_id)==TRUE){
            ...
            $this->form_validation->set_message("checkURL","Vi_link has been exit, please try again");
            return FALSE;
        }
    }
