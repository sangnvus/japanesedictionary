...
<body>
	...
	<div id="giua">
		...
		<form name="replyContact" id="addNewAdmin" action="" method="post" enctype="multipart-formdata">
					<label><b>ID: </label><?php echo form_input($contact_id);?><br><br />
					<label><b>Email: </label><?php echo form_input($contact_email);?><br><br />
					<label><b>Content:</label><?php echo form_textarea($contact_content);?><br><br />
