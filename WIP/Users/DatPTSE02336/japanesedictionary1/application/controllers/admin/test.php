...
class Test extends CI_Controller
{
	...
	function addTest(){
        ...
        if (isset($_POST['addnew'])) {
            ...
            $this->form_validation->set_rules("test_id","test_id","required|max_length[32]");
            $this->form_validation->set_rules("test_category","test_category","required");
            $this->form_validation->set_rules("test_level","test_level","required");
            //$this->form_validation->set_rules("test_content","test_content","required");                   
	...
	function editTest(){
        ...
        {            
            ...
            {                  
                    ...
                    $this->form_validation->set_rules("question_content","question_content","required");                                                                                   
                    $this->form_validation->set_rules("answer_content","answer_content","required");
