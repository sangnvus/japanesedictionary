...
class ReadingDocument extends CI_Controller
{
	...
	function addReading(){
        ...
        if (isset($_POST['addnew'])) {
            ...
            $this->form_validation->set_rules("reading_id","reading_id","required|max_length[32]");
            $this->form_validation->set_rules("reading_title","reading_title","required");
            $this->form_validation->set_rules("reading_level","reading_level","required");
	...
	function addContent(){
        ...
        {            
            ...
            {                       
                    ...
                    $this->form_validation->set_rules("readingvocabulary_hiragana","readingvocabulary_hiragana","required");                                          
                    $this->form_validation->set_rules("readingvocabulary_meaning","readingvocabulary_meaning","required");
                    $this->form_validation->set_rules("readingvocabulary_kanji","readingvocabulary_kanji","required");                                                                                  
                    $this->form_validation->set_rules("reading_type","reading_type","required");
                ...
                if($this->form_validation->run()==FALSE){   
                    $this->load->view("admin/readingdocument/addContent_view",$data);                
                      ...
                      $content = array(          
                                    ...
                                    "reading_type"     => $this->input->post("reading_type")                                    
                                 );                      
	...
	function addContentArticle(){
        ...
        {            
            ...
            {                       
                    ...
                    $this->form_validation->set_rules("readingarticle_content","readingarticle_content","required");                                          
                    $this->form_validation->set_rules("readingarticle_question","readingarticle_question","required");
                    $this->form_validation->set_rules("readingarticle_answer","readingarticle_answer","required");                                                                                  
                    $this->form_validation->set_rules("reading_type","reading_type","required");
