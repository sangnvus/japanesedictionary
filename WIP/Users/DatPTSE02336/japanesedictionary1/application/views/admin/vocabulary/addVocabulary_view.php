	...
	<div id="giua">
		...
		<div id="main-content">
			...
			<form name="addVocabulary" id="addNewAdmin" action="" method="post" enctype="multipart-formdata">		        		        
		        <label>V_hiragana: </label><?php echo form_input($v_hiragana);?><font width="1%" style="color:red;">(*)</font><br />
		        <label>V_romaji: </label><?php echo form_input($v_romaji);?><font width="1%" style="color:red;">(*)</font><br />		        		        		        
