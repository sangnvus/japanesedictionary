	...
	<div id="giua">
		...
		<div id="main-content-vocab">
			...
			<table border="1" width="110%">
				...
				<td><?php echo $readingArticle['readingarticle_content']; ?></td>	
				<td><?php echo $readingArticle['readingarticle_question']; ?></td>
				<td><?php echo $readingArticle['readingarticle_answer']; ?></td>	
				<td><?php echo $readingArticle['reading_type']; ?></td>
