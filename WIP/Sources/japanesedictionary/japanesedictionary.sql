...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2014 at 04:06 PM
...
(2, 'Bài 2 : Tôi đến từ Việt Nam - ベトナムから来ました', 'Giao tiếp', 'Penguins.jpg'),
(3, 'Bài 3 : Quyển sách này là của ai vậy - この本はだれの本ですか', 'Giao tiếp', 'Chrysanthemum1.jpg'),
(4, 'Bài 4 : Nơi nào thế? - どこですか？', 'Giao tiếp', 'Tulips.jpg'),
(5, 'Bài 5 : Giá bao nhiêu vậy? - いくらですか', 'Giao tiếp', 'communication5.png'),
(7, 'Hội thoại - Sơ cấp - Bài 2', 'Sơ cấp', ''),
(8, 'Hội thoại - Sơ cấp - Bài 3', 'Giao tiếp', ''),
(9, 'Hội thoại - Sơ cấp - Bài 4', 'Giao tiếp', ''),
(11, ' Hội thoại - Trung cấp 1 - Bài 1', 'Trung cấp 1', 'Chrysanthemum5.jpg'),
(12, ' Hội thoại - Trung cấp 1 - Bài 2', 'Giao tiếp', ''),
...
(21, 'Hội thoại_sơ cấp_Bài 12', 'Sơ cấp', ''),
(22, 'Hội thoại_sơ cấp_Bài 34', 'Sơ cấp', ''),
(23, 'Hội thoại_sơ cấp_Bài 309', 'Sơ cấp', ''),
(24, 'Hội thoại - Sơ cấp - Bài 1111', 'Sơ cấp', 'Chrysanthemum.jpg'),
(25, 'Hội thoại - Sơ cấp - Bài 2', 'Giao tiếp', 'Chrysanthemum3.jpg'),
(26, 'Hội thoại - Sơ cấp - Bài 2111111111111', 'Sơ cấp', 'Chrysanthemum2.jpg'),
(27, 'Bài 1 : Chào hỏi cơ bản - 基本的な挨拶', 'Sơ cấp', NULL);
...
(22, '～によって／～により／～による／～によっては', '123123213', 'N1', 'Nhờ vào, do, bởi ~', 'asdasdasdasd', 1, '');
...
(1, 1, 'sự bất tiện; lỗi', 'Noun', '不具合 ', 'IT'),
(2, 2, 'sự mở rộng; sự khuyếch trương', 'Noun', '拡張 ', ''),
(3, 2, 'mở rộng; khuyếch trương', 'Verb', '拡張する ', ''),
(4, 3, 'dạt dào; tràn trề; đầy rẫy', 'Verb', '漂う ', ''),
(5, 3, 'lộ ra; tỏ ra', 'Verb', '漂う ', ''),
(6, 3, 'nổi; nổi lềnh bềnh; trôi nổi', 'Verb', '漂う', ''),
(7, 4, 'sự đưa vào; sự giới thiệu', 'Noun', ' 導入', ''),
(8, 4, 'đưa vào (sử dụng, áp dụng...)', 'Verb', ' 導入する', ''),
(9, 5, 'sự xử lý; sự giải quyết', 'Noun', '処理', ''),
(10, 5, 'xử lý; giải quyết', 'Verb', '処理する', ''),
(11, 6, 'trung tâm', 'Noun', '中心 ', ''),
(12, 6, 'sự thật tâm', 'Noun', '衷心 ', ''),
(13, 7, 'thực hiện', 'Noun', '実現', ''),
(14, 7, 'thực hiện; thi hành', 'Verb', '実現する', ''),
(15, 8, 'đăng ký', 'Verb', '応じる ', ''),
(16, 8, 'đáp ứng; trả lời', 'Verb', '応じる', ''),
(17, 8, 'nhận lời', 'Verb', '応じる', ''),
(18, 8, 'phù hợp; ứng với; dựa trên', 'Verb', '応じる ', ''),
(19, 9, 'sự tính toán; tính toán', 'Noun', '計算', ''),
(20, 9, 'tính; tính toán', 'Verb', '計算する ', ''),
(21, 10, 'lĩnh vực', 'Noun', '分野', ''),
(22, 11, 'kim ngạch; số tiền', 'Noun', '金額', ''),
(23, 12, 'hạn định; hạn chế', 'Verb', '限定する', ''),
(24, 13, 'sự tốt nghiệp', 'Noun', '卒業', ''),
(25, 13, 'tốt nghiệp', 'Verb', '卒業する ', ''),
(26, 14, 'sự trúng tuyển; sự thi đỗ', 'Noun', '合格', ''),
(27, 14, 'trúng tuyển; thi đỗ', 'Verb', '合格する ', ''),
(28, 15, 'khả năng,năng lực', 'Noun', '能力', ''),
(29, 16, 'học', 'Verb', '学ぶ', ''),
(30, 17, 'sự giả định', 'Noun', '仮定', ''),
(31, 17, 'gia đình', 'Noun', '家庭', ''),
(32, 17, 'giáo trình giảng dạy; khóa trình', 'Noun', '課程', ''),
(33, 17, 'quá trình; giai đoạn', 'Noun', '過程', ''),
(34, 18, 'chậm; trễ; muộn', 'Verb', '遅れる ', ''),
(35, 19, 'buồn, cô đơn', 'Adjective', '寂しい', ''),
(36, 20, 'kém, dốt', 'Adjective', '下手', ''),
(37, 21, 'kém; yếu', 'Adjective', '苦手', ''),
(38, 22, 'đường cong', 'Noun', '曲線', 'Math'),
(39, 23, 'phẩm chất loại một ', 'Noun', '最上品', 'foreign trade'),
(40, 24, 'người vỡ nợ [bankrupt]', 'Noun', '破産人', 'foreign trade'),
(42, 26, 'sự kiện, sự việc [event]', 'Noun', '事象', ''),
(43, 27, 'nhị phân [binary]', 'Noun', '二元', 'IT'),
(44, 28, 'nhân đôi, dư thừa [duplication]', 'Noun', '二重化', 'IT'),
(45, 29, 'đặc tả [means, specification]', 'Noun', '仕様 ', 'IT'),
(46, 29, 'dùng riêng, sử dụng cá nhân', 'Noun', '私用', 'IT'),
(47, 30, 'sự xác nhận [validation]', 'Noun', '確認', 'IT'),
(48, 31, 'ktra sự hợp lệ [validation test]', 'Noun', '確認試験', 'IT'),
(49, 32, 'yêu cầu [requirement]', 'Noun', '要件', 'IT'),
(50, 33, 'yêu cầu [requirement]', 'Noun', '要求', 'IT'),
(51, 34, 'kiểu phần tử [element type]', 'Noun', '要素型', 'IT'),
(52, 35, 'từ khoá [title word, keyword]', 'Noun', '見出し語', 'IT'),
(53, 36, 'sự giải nén [decompression (vs)]', 'Noun', '解凍', 'IT'),
(54, 37, 'sửa chữa [fix (vs), correction]', 'Noun', '訂正', 'IT'),
(55, 38, 'biểu tượng [sign, symbol]', 'Noun', '記号', 'IT'),
(56, 39, 'chứng khoán [instrument, stock]', 'Noun', '証券', 'foreign trade'),
(57, 40, 'đánh giá, ước giá [Evaluation]', 'Noun', '評価', 'Marketing  '),
(59, 41, '12312323', 'Noun', '', '');
...
(1, 16, '1.そんこうえんは　しずかで　（　　　）ので、　よく　さんぽに　いきます。'),
(2, 16, ' 2. こどもたちに　ものを　たいせつにする（　　　）　いつも　いっています。'),
(3, 16, '3. おきゃくさまが　りょかんに　（　　　）なりました。'),
(4, 16, '4. わたしは　テレビをみるより、　ほんを　よむ（　　　）　すきだ。'),
(5, 16, '5. もうわたしより　むすこのほうが、ちからが（　　　）　かもしれませんね'),
(6, 11, '門（1）　この人はいつ　病院にいきますか?'),
(7, 11, ' 門（2）パーテイーに来る人は　なんよう日に　おかねをはこにいれますか。'),
(8, 11, '門（3）　うえと　おなじ　いみの　ぶんを　えらびなさい。  '),
(9, 11, '門（4）　この人は、何ページ　読みましたか。  '),
(10, 11, '門（5）かばんがほしいですか  '),
(11, 1, 'いつ＿＿＿＿いちばん　ひまですか。'),
(12, 1, 'いつ＿＿＿＿いちばん　ひまですか。'),
(13, 1, 'いつ＿＿＿＿いちばん　ひまですか。'),
(14, 1, 'いつ＿＿＿＿いちばん　ひまですか。'),
(15, 1, 'いつ＿＿＿＿いちばん　ひまですか。'),
(16, 6, '女：この教室、ずいぶん暑いね。\n男：＿＿＿＿＿＿＿＿＿＿。'),
(17, 6, 'つぎのことばの使い方として最も近いものを、一つえらびなさい。'),
(18, 6, '女の人の息子がかいた絵はどれですか。'),
(19, 6, '男の人はどの人ですか。'),
(20, 6, 'お腹の周りが特に太くなってきたしね。');
...
(1, 15, 'キッチン', 'nhà bếp', '', 'Noun'),
(2, 15, 'だいどころ', 'nhà bếp', '台所', 'Noun'),
(3, 15, 'でんしレンジ', 'lò vi ba', '電子レンジ', 'Noun'),
(4, 15, 'ワイングラス', 'cốc uống rượu (có chân)', '', 'Noun'),
(5, 15, 'コーヒーカップ', 'cốc uống cà phê', '', 'Noun'),
(6, 15, 'ゆのみ', 'cốc uống trà', '湯飲み', 'Noun'),
(7, 15, 'ガラスのコップ', 'cốc thủy tinh', '', 'Noun'),
(8, 15, 'ガスレンジ', 'bếp ga', '', 'Noun'),
(9, 15, 'ながし', 'bồn rửa; chậu rửa', '流し', 'Noun'),
(10, 15, 'いま', 'phòng khách', '居間', 'Noun'),
(11, 15, 'てんじょう', 'trần nhà', '天井', 'Noun'),
(12, 15, 'コンセント', 'ổ cắm (điện)', '', 'Noun'),
(13, 15, 'エアコン', 'máy điều hòa không khí', '', 'Noun'),
(14, 15, 'ヒーター', 'máy sưởi; lò sưởi', '', 'Noun'),
(15, 15, 'コード', 'dây điện', '', 'Noun'),
(18, 1, 'やちん', 'tiền thuê nhà', '家賃', 'Noun'),
(19, 1, 'かんりひ', 'phí quản lý', '管理費', 'Noun'),
(20, 1, 'ただ', 'miễn phí', '', 'adv'),
(21, 1, 'マンション', 'chung cư', '', 'Noun'),
(22, 1, 'しききん', 'tiền đặt cọc (sau này hoàn trả lại)', '敷金', 'Noun'),
(23, 1, 'れいきん', 'tiền lễ (sau này không hoàn trả lại)', '礼金', 'Noun'),
(24, 1, 'ながめがいい', 'tầm nhìn tốt', '', 'Adjective'),
(25, 1, 'ひとりぐらし', 'sống một mình', '一人暮らし', 'Adjective'),
(26, 1, 'きんじょづきあい', 'quan hệ hàng xóm', '近所付き合い', 'Adjective'),
(27, 1, 'かれとつきあう', 'kết giao bạn trai', '彼と付き合う', 'Verb'),
(28, 1, 'ともだちにつきあう', 'kết giao bạn bè', '友達に付き合う', 'Verb'),
(29, 1, 'このふきん', 'quanh đây', 'この付近', 'Noun'),
(30, 1, 'まんまえ', 'ngay phía trước', '真ん前', 'Noun'),
(31, 29, 'わたし', 'tôi', '', 'Noun'),
(32, 29, 'わたしたち', 'chúng tôi, chúng ta', '', 'Noun'),
(33, 29, 'あなた', 'anh/ chị/ ông/ bà,', '', 'Noun'),
(34, 29, 'あのひと', 'người kia, người đó', 'あの人', 'Noun'),
(35, 29, 'あのかた', 'vị kia', 'あの方', 'Noun'),
(36, 29, 'みなさん', 'các anh chị, các ông bà, các bạn, quý vị', '皆さん', 'Noun'),
(37, 29, 'がくせい', 'học sinh, sinh viên', '学生', 'Noun'),
(38, 29, 'せんせい', 'thầy/ cô', '先生', 'Noun'),
(39, 29, 'かいしゃいん', 'nhân viên công ty', '会社員', 'Noun'),
(40, 29, 'ぎんこういん', 'nhân viên ngân hàng', '銀行員', 'Noun'),
(41, 29, 'いしゃ', 'bác sĩ', '医者', 'Noun'),
(42, 29, 'エンジニア', 'kỹ sư', '', 'Noun'),
(43, 29, 'だいがく', 'đại học, trường đại học', '大学', 'Noun'),
(44, 29, 'びょういん', 'bệnh viện', '病院', 'Noun'),
(45, 29, 'でんき', 'điện, đèn điện', '電気', 'Noun'),
(47, 1, '213123123', '123123', '12312', 'Verb');
...
(1, 'N4_Chokkai_001', 'Listening', 'N4', ''),
(2, 'N4_Bunpou_002', 'Grammar', 'N4', ''),
(3, 'N4_Bunpou_003', 'Grammar', 'N4', ''),
(4, 'N4_Bunpou_004', 'Grammar', 'N4', ''),
(5, 'N4_Bunpou_005', 'Grammar', 'N4', ''),
(6, 'N4_Choukai_001', 'Listening', 'N4', 'N4Choukai1.mp3'),
(7, 'N4_Choukai_002', 'Listening', 'N4', 'N4Choukai2.mp3'),
(9, 'N4_Choukai_004', 'Listening', 'N4', 'N4Choukai4.mp3'),
(10, 'N4_Choukai_005', 'Listening', 'N2', 'N4Choukai5.mp3'),
(11, 'N4_Dokkai_001', 'Reading', 'N4', '（1）きょうはあさから　おなかがいたいです。きのう　たべたものがわるかったのです。いまから　びょういんに　行きます。（2）らいしゅうのきんよう日にパーテイーをします。パーテイーに来るひとは二日までに　このはこに　おかねを　入れてください（3）わたしのちちはことし60さいです。わかいときからだがよわくてよくかいしゃを　やすみました。（4）しかし　いまはまいにちあさ　はやくからよる　おそうまではたらきます。(5)かばんがほしいですか。'),
(12, 'N4_Dokkai_002', 'Reading', 'N4', '（1）きょうはあさから　おなかがいたいです。きのう　たべたものがわるかったのです。いまから　びょういんに　行きます。（2）らいしゅうのきんよう日にパーテイーをします。パーテイーに来るひとは二日までに　このはこに　おかねを　入れてください（3）わたしのちちはことし60さいです。わかいときからだがよわくてよくかいしゃを　やすみました。（4）しかし　いまはまいにちあさ　はやくからよる　おそうまではたらきます。(5)かばんがほしいですか。'),
(13, 'N4_Dokkai_003', 'Reading', 'N4', '（1）きょうはあさから　おなかがいたいです。きのう　たべたものがわるかったのです。いまから　びょういんに　行きます。（2）らいしゅうのきんよう日にパーテイーをします。パーテイーに来るひとは二日までに　このはこに　おかねを　入れてください（3）わたしのちちはことし60さいです。わかいときからだがよわくてよくかいしゃを　やすみました。（4）しかし　いまはまいにちあさ　はやくからよる　おそうまではたらきます。(5)かばんがほしいですか。'),
(14, 'N4_Dokkai_004', 'Reading', 'N4', '（1）きょうはあさから　おなかがいたいです。きのう　たべたものがわるかったのです。いまから　びょういんに　行きます。（2）らいしゅうのきんよう日にパーテイーをします。パーテイーに来るひとは二日までに　このはこに　おかねを　入れてください（3）わたしのちちはことし60さいです。わかいときからだがよわくてよくかいしゃを　やすみました。（4）しかし　いまはまいにちあさ　はやくからよる　おそうまではたらきます。(5)かばんがほしいですか。'),
(15, 'N4_Dokkai_005', 'Reading', 'N4', '（1）きょうはあさから　おなかがいたいです。きのう　たべたものがわるかったのです。いまから　びょういんに　行きます。（2）らいしゅうのきんよう日にパーテイーをします。パーテイーに来るひとは二日までに　このはこに　おかねを　入れてください（3）わたしのちちはことし60さいです。わかいときからだがよわくてよくかいしゃを　やすみました。（4）しかし　いまはまいにちあさ　はやくからよる　おそうまではたらきます。(5)かばんがほしいですか。'),
(16, 'N4_Moji_001', 'Vocabulary', 'N4', ''),
(17, 'N4_Moji_002', 'Vocabulary', 'N4', ''),
(18, 'N4_Moji_003', 'Vocabulary', 'N4', ''),
(19, 'N4_Moji_004', 'Vocabulary', 'N4', ''),
(20, 'N4_Moji_005', 'Vocabulary', 'N4', '');
...
(6, 'Choukai(これで大丈夫)_N4&N5_絵のある問題_P1', 'N2N3'),
...
(3, 'datpt2', 'e00cf25ad42683b3df678c61f42c6bda', 1, NULL, 'admin1@gmail.com', '2014-08-10', 1);
...
(2, 'Trồng ớt xanh trên gác xép - Hoạt hình Doraemon', '//www.youtube.com/embed/5Hzv84neJOw');
