	...
	<div id="giua">
		...
		<div id="main-content-vocab">
			...
			<table border="1" width="100%" id="table-substring">
				...
				<td><?php echo $conversation['c_image']; ?></td>
				<td><?php echo $conversation['con_id']; ?></td>
				<td><p><?php echo $conversation['con_title']; ?></p></td>				
				<td><p><?php echo $conversation['con_hiragana']; ?></p></td>
				<td><p><?php echo $conversation['con_romaji']; ?></p></td>
				<td><p><?php echo $conversation['con_meaning']; ?></p></td>
				<td><p><?php echo $conversation['con_file']; ?></p></td>
