	...
	<div id="giua">
		...
		<div id="main-content-vocab">
			...
			<div id="boxsearch">
				...
				Romaji: <input name="txtRomaji" maxlength="200">
			...
			<div><?php echo '<a href="'.base_url().'index.php/admin/vocabulary/listContributedVocab"><input name="listvocab" type="submit" value="List Contributed Vocabulary"></a>'; ?></div>
			</div>
			<div id="table-user">
