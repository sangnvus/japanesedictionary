...
<head>
	...
	<title>Danh sách ngữ pháp N2</title>
</head>
<body>
<div id="container">
		<?php 
	...
	<div id="content">
		...
		<div id="noidung">
				...
				<div id="main-content">
					<div id="left-content">
						...
						<div align="left"><a style="font-size:20px;" id="btnSearch" href="<?php echo base_url();?>index.php/Home/home/review">Quay lại &nbsp</a></div>
							<center><h2>Danh sách ngữ pháp N2</h2></center>
	        <?php if ($grammar !== null) {?>
			<table id="table1" width="90%" cellpadding="10" style="margin-left:5%;margin-right:5%;">
				...
				<?php if($num_rows_listGrammarN2 > 0){ ?>	
			...
			<div align="right" id="paging" class="pagination" style="margin-right:5%" >
	                  <?php
	                    if($num_rows_listGrammarN2>0){
	                        echo $links;
	                        echo " | Tổng số ngữ pháp : ".$num_rows_listGrammarN2;
	                    }
	                  ?>
	        </div>
			<?php }else
