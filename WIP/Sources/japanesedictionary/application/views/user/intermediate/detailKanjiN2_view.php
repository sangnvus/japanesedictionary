...
<head>
	...
	<title>Chi tiết chữ Hán N2</title>
</head>
<body>
<div id="container">
		<?php 
			...
			<center>
				...
				<div id="main-content">
					<div id="left-content">
						...
						<div id="left"><a style="font-size:20px;" id="btnSearch" href="<?php echo base_url();?>index.php/Home/home/KanjiN2">Quay lại &nbsp</a></div><br>
						<div id="left-subtitle"><h2>日本語総まとめN2_ (Giáo trình ôn thi N2_Hán Tự)</h2></div>								
	                    ...
	                    <?php 
	                    if ($detailKanjiN2 != null) {
	                    	foreach ($detailKanjiN2 as $row) {	
	                     ?>
	                    <tr>
