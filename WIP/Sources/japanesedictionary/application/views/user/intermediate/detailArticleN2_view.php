...
<head>
	...
	<title>Chi tiết bài đọc N2</title>
</head>
<body>
<div id="container">
		<?php 
			...
			<center>
				...
				<div id="main-content">
					<div id="left-content">
						...
						<div id="left"><a style="font-size:20px;" id="btnSearch" href="<?php echo base_url();?>index.php/Home/home/articleN2">Quay lại &nbsp</a></div><br>
						<div id="left-subtitle"><h2>日本語総まとめN2_語彙 (Giáo trình ôn thi N2_Bài Đọc)</h2></div>								
						<?php 
						if ($detailArticleN2 != null) {
							foreach ($detailArticleN2 as $row) {					
						 ?>
