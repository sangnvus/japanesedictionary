...
<head>
	...
	<title>Chi tiết bài đọc N3</title>
</head>
<body>
<div id="container">
		<?php 
			...
			<center>
				...
				<div id="main-content">
					<div id="left-content">
						...
						<div id="left"><a style="font-size:20px;" id="btnSearch" href="<?php echo base_url();?>index.php/Home/home/articleN3">Quay lại &nbsp</a></div><br>
						...
						if ($detailArticleN3 != null) {
						 ...
						 <div align="left" style="margin-left:30px;font-size:18px;">
			              ...
			              <div id="test" align="left" style="margin-left: 20px; display: none;">
			                ...
			                <font style="font-size:14px;color:red;margin-left:20px;">Dịch :</font>
			                						<?php echo $row['readingarticle_meaning']; ?>
			                <br><br><font style="font-size:14px;color:red;margin-left:20px;">Đáp án trả lời :</font><br><?php echo nl2br($row['readingarticle_answer']); ?>
			                </p>
			               </div>
						 <?php }} ?>
            			</div>
