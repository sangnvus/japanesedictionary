...
<head>
	...
	<title>danh sách chữ Hán N5</title>
</head>
<body>
<div id="container">
		<?php 
	...
	<div id="content">
		...
		<div id="noidung">
				...
				<div id="main-content">
					<div id="left-content">
						<div id="intro-content">
							<center><h2 style="color:blue;">DANH SÁCH CHỮ HÁN N5</h2></center>
	        <?php if ($kanji !== null) {?>
			...
			<div align="right" id="paging" class="pagination" style="margin-right:5%">
	                  <?php
	                    if($num_rows_kanjiN5>0){
	                        echo $links;
	                        echo " | Số từ : ".$num_rows_kanjiN5;
	                    }
	                  ?>
	            </div>
			<?php }else
