...
class Kanji extends CI_Controller
{
	...
	function addKanji(){
        ...
        if (isset($_POST['addnew'])) {
            ...
            $this->form_validation->set_rules("k_kanji","k_kanji","required|is_unique[kanji.k_kanji]|max_length[10]");
            $this->form_validation->set_rules("k_hanviet","k_hanviet","required|max_length[50]");
            $this->form_validation->set_rules("k_onyomi", "k_onyomi", 'trim|max_length[100]');
            $this->form_validation->set_rules("k_kunyomi", "k_kunyomi", 'trim|max_length[100]');
            $this->form_validation->set_rules("k_meaning","k_meaning","required|max_length[100]");
            $this->form_validation->set_rules("k_level","k_level","required|max_length[10]");                            
            $this->form_validation->set_rules("reading_id","reading_id","max_length[20]");
