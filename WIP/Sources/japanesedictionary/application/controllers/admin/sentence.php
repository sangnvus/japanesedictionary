...
class Sentence extends CI_Controller
{
    ...
    function addSentence(){
        ...
        if (isset($_POST['addnew'])) {
            ...
            $this->form_validation->set_rules("s_hiragana","s_hiragana","required|max_length[1000]");
            $this->form_validation->set_rules("s_romaji","s_romaji","required|max_length[1000]");
            $this->form_validation->set_rules("s_meaning","s_meaning","required|max_length[1000]");
            $this->form_validation->set_rules("s_kanji","s_kanji","required|max_length[1000]");                            
