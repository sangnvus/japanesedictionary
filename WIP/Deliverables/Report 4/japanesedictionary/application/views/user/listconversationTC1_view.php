...
<head>
	...
	<title>Danh sách hội thoại trung cấp 1</title>
</head>
<body>
<div id="container">
		<?php 
	...
	<div id="content">
		...
		<div id="noidung">
				...
				<div id="main-content">
					<div id="left-content">
						<div id="intro-content">
							<center><h2 style="color:blue;">DANH SÁCH BÀI HỘI THOẠI TRUNG CẤP 1</h2></center>
	        <?php if ($conversation !== null) {?>
			<table id="table1"  cellpadding="10" >
				<tbody>
				<?php if($num_rows_conversationTC1 > 0){ ?>	
			...
			<div align="right" id="paging" class="pagination" style="margin-right:5%">
	                  <?php
	                    if($num_rows_conversationTC1>0){
	                        echo $links;
	                        echo " | Số bài : ".$num_rows_conversationTC1;
	                    }
	                  ?>
	            </div>
			<?php }else
