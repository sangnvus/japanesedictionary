...
<head>
	...
	<title>Danh sách bài đọc N3</title>
</head>
<body>
<div id="container">
		<?php 
			...
			<center>
				...
				<div id="main-content">
					<div id="left-content">
						...
						<div id="left-subtitle"><h2>日本語総まとめN3_会話(Giáo trình ôn thi N3_Bài Đọc)</h2></div>								
						<table width="100%" cellpadding="8">
			             ...
			             <?php 
			             	foreach ($listArticleN3 as $row) {
			              ?>
			             <tr><td bgcolor="E5EFF8">
			             <?php echo '<a href="'.base_url().'index.php/Home/home/detailArticleN3/'.$row['reading_id'].'">';?>
